> Archivé le 2026-07-02 — remplacé par docs/status.md (état) et docs/TODO-NATIVE-ENGINE.md (chantier moteur natif).
...
| [ ] | Consommateurs tiers du core (contexte code) | ECOSYSTEM_ARCHITECTURE.md |
