...
- **CLI : ✅ surface complète** ; tests partiels en CI ; **cargo-dist** pas encore fait.
- **Reste ouvert (priorité)** : release 0.2.0, bench Mem0+Qdrant, NAPI live
  subscriptions, CUDA/NVML, image Docker REST.
