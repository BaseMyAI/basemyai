...
//! iteration order == key order for free, which
//! `store::sst_block::BlockSstFile::write_new` relies on when it turns a
//! flushed memtable into a sorted, block-based SST file.
