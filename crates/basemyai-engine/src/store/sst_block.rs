...
/// Result of [`BlockSstFile::entries_with_prefix`]: the matching entries in
/// ascending key order, plus the number of data blocks actually decoded to
/// produce them (the pruning invariant the tests pin).
